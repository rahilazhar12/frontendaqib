...
const Loginpage = () => {
    ...
    const handleLogin = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post(`https://aqib-a9ae691e09a3.herokuapp.com/api/v1/auth/login`, { email, password });
            ...
            if (error.response) {
                ...
                // Handle errors unrelated to the HTTP response (like network issues)
    ...
    return (
        <>
            <section className="bg-gray-50 h-[665px] flex items-center justify-center bg-cover" style={{ backgroundImage: "" }}>
                {/* login container */}
            ...
            <div className="mt-3 text-xs flex justify-between items-center text-[#002D74]">
              ...
              <button className="py-2 px-5 bg-white border rounded-xl hover:scale-110 duration-300">Register</button>
                    ...
                    <div className="md:block hidden w-1/2">
                        <img className="rounded-2xl" src="https://www.shutterstock.com/image-photo/secure-online-access-password-login-600nw-2140881663.jpg" />
                    </div>
                </div>
            </section>
